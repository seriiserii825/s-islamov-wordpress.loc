              ...
              <!-- post -->
               <article class="post">
                  ...
                  <div class="post-thumb">
                     <?php echo kama_thumb_img(['w' => 640, 'h' => 246]); ?>
                  </div>
                  ...
                  <div class="post-content">
                     ...
                     <ul class="post-nav cf">
                        <li class="prev"><a rel="prev" href="#"><?php previous_post_link( '%link', '<strong>%title</strong>'); ?></a></li>
                        <li class="next"><a rel="next" href="#"><?php next_post_link( '%link', '<strong>%title</strong>'); ?></a></li>
                     </ul>
